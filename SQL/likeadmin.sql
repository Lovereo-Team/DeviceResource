...
-- Records of la_album
-- ----------------------------
INSERT INTO `la_album` VALUES (1, 0, 1, 0, 10, 'test.png', 'image/20240304/4d596f53971048b5ba6a223406d18ba4.png', 'png', 21632, 0, 1712132667, 1712132667, 0);
...
-- ----------------------------
INSERT INTO `la_gen_table` VALUES (2, 'la_member', '员工列表', '', '', '', 'member', 'member', '员工列', '', '', '', 'crud', 0, '/', '', 1712058383, 1712058383);
INSERT INTO `la_gen_table` VALUES (4, 'la_resource', '溯源列表', '', '', '', 'resource', 'resource', '溯源列', '', '', '', 'crud', 0, '/', '', 1712125295, 1712125295);
...
CREATE TABLE `la_gen_table_column`  (
  ...
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成字段表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of la_gen_table_column
-- ----------------------------
INSERT INTO `la_gen_table_column` VALUES (14, 2, 'id', '', '10', 'int', 'int', 'id', 1, 1, 1, 0, 1, 0, 0, '=', 'input', '', 1, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (15, 2, 'username', '用户名', '255', 'varchar', 'string', 'username', 0, 0, 1, 1, 1, 1, 1, 'LIKE', 'input', '', 2, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (16, 2, 'password', '密码', '255', 'varchar', 'string', 'password', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 3, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (17, 2, 'real_name', '真实姓名', '255', 'varchar', 'string', 'real_name', 0, 0, 1, 1, 1, 1, 1, 'LIKE', 'input', '', 4, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (18, 2, 'email', '邮箱', '255', 'varchar', 'string', 'email', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 5, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (19, 2, 'status', '用户状态 1：正常 2：禁用', '1', 'tinyint', 'int', 'status', 0, 0, 1, 1, 1, 1, 1, '=', 'radio', '', 6, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (20, 2, 'login_time', '登录时间', '11', 'int', 'int', 'login_time', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 7, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (21, 2, 'create_time', '创建时间', '11', 'int', 'core.TsTime', 'create_time', 0, 0, 0, 0, 0, 1, 0, '=', 'datetime', '', 8, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (22, 2, 'update_time', '更新时间', '11', 'int', 'core.TsTime', 'update_time', 0, 0, 0, 0, 0, 1, 0, '=', 'datetime', '', 9, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (23, 2, 'token', '用户凭证', '255', 'varchar', 'string', 'token', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 10, 1712058383, 1712058383);
INSERT INTO `la_gen_table_column` VALUES (33, 4, 'id', '', '20', 'int', 'int', 'id', 1, 1, 1, 0, 1, 0, 0, '=', 'input', '', 1, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (34, 4, 'member_id', '员工编号', '20', 'int', 'int', 'member_id', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 2, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (35, 4, 'device_code', '设备编号', '100', 'varchar', 'string', 'device_code', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 3, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (36, 4, 'date', '扫码日期', '0', 'date', 'core.TsTime', 'date', 0, 0, 1, 1, 1, 1, 1, '=', 'datetime', '', 4, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (37, 4, 'img_top', '图片_上', '255', 'varchar', 'string', 'img_top', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 5, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (38, 4, 'img_front', '图片_前', '255', 'varchar', 'string', 'img_front', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 6, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (39, 4, 'img_behind', '图片_后', '255', 'varchar', 'string', 'img_behind', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 7, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (40, 4, 'img_left', '图片_左', '255', 'varchar', 'string', 'img_left', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 8, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (41, 4, 'img_right', '图片_右', '255', 'varchar', 'string', 'img_right', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 9, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (42, 4, 'img_s', '图片集合', '0', 'text', 'string', 'img_s', 0, 0, 1, 1, 1, 1, 1, '=', 'textarea', '', 10, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (43, 4, 'video', '视频', '255', 'varchar', 'string', 'video', 0, 0, 1, 1, 1, 1, 1, '=', 'input', '', 11, 1712125295, 1712125295);
INSERT INTO `la_gen_table_column` VALUES (44, 4, 'create_time', '创建时间', '100', 'int', 'core.TsTime', 'create_time', 0, 0, 0, 0, 0, 1, 0, '=', 'datetime', '', 12, 1712125295, 1712125295);
...
CREATE TABLE `la_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '员工列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of la_member
-- ----------------------------
INSERT INTO `la_member` VALUES (1, 'aaa', 'aaaaaaaaaaaaaaaaaaaa', 'aaaa', 'aaaaaaa', 2, 0, 0, 0, '0');
INSERT INTO `la_member` VALUES (2, 'aaaaaaa', 'aaaa', 'aaaaaa', 'aaaaa', 1, 0, 0, 0, '');
INSERT INTO `la_member` VALUES (3, 'aaaa', '3dbe00a167653a1aaee01d93e77e730e', 'aaaaa', 'aaaaa', 1, 0, 0, 0, '');
INSERT INTO `la_member` VALUES (4, 'aaaaaa', '0b4e7a0e5fe84ad35fb5f95b9ceeac79', 'aaaaaaaa', 'aaaaaaaaa@qq.com', 1, 0, 0, 0, '55cce713b2e74093162927120d18c360d50777');
INSERT INTO `la_member` VALUES (5, 'aaaaa', '4eac81e0b6586fcee73aa7d29265070a', 'aaaaa', 'aaaaaaa@qq.com', 1, 0, 1712117682, 0, 'ae69d3ecabf2bc8c4ddf1fb3c01c60f5wjskgq');
INSERT INTO `la_member` VALUES (6, 'aaa', '47bce5c74f589f4867dbd57e9ca9f808', 'aaa', 'aaaa@qq.com', 1, 0, 1712122623, 0, 'ffd57f7f1a1941db77f086752223612fKmhzhE');
INSERT INTO `la_member` VALUES (7, 'aaa', '47bce5c74f589f4867dbd57e9ca9f808', 'aaa', 'aaa@qq.com', 1, 0, 1712122642, 0, 'a7316ac390ad8b6e824c77ce82a8402fIJlsJu');
INSERT INTO `la_member` VALUES (8, 'aaaaaaaaa', '3dbe00a167653a1aaee01d93e77e730e', 'aaaaaaaaaa', 'aaaaaaa@qq.com', 1, 0, 1712123415, 0, '20450e6c669e6ccd3815abbd8146e711HRhMsL');
INSERT INTO `la_member` VALUES (9, 'bbb', '594f803b380a41396ed63dca39503542', 'bbbb', 'bbbbb@qq.com', 1, 0, 1712123451, 1712123588, 'e82aaec178966cfff5d88b90fcb93dcfZDQY0V');
...
CREATE TABLE `la_resource`  (
  ...
  `img_top` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片_上',
  `img_front` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片_前',
  `img_behind` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片_后',
  `img_left` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片_左',
  `img_right` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片_右',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '溯源列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of la_resource
-- ----------------------------
INSERT INTO `la_resource` VALUES (1, 1, '1', '2024-04-03', 'http://127.0.0.1:8000/api/uploads/image/20240304/4d596f53971048b5ba6a223406d18ba4.png', '0', '0', '0', '0', '0', '0', 1712117682);
...
-- ----------------------------
INSERT INTO `la_system_auth_admin` VALUES (1, 1, 0, 'admin', 'admin', '7fac2474740becfaf1ecbdd6cc8fb076', '/api/static/backend_avatar.png', '0', '5Xar0', 0, 1, 0, 0, '127.0.0.1', 1712131689, 1642321599, 1712131689, 0);
...
INSERT INTO `la_system_auth_menu` VALUES (775, 610, 'A', '编辑', '', 0, 'gen:editTable', '', '', '', '', 1, 1, 0, 1712058847, 1712058847);
INSERT INTO `la_system_auth_menu` VALUES (776, 0, 'M', '员工列表', 'el-icon-User', 0, '', 'member', '', '', '', 1, 1, 0, 1712062820, 1712062820);
INSERT INTO `la_system_auth_menu` VALUES (777, 776, 'C', '员工列表', 'el-icon-UserFilled', 0, '', 'member/index', 'member/index', '', '', 1, 1, 0, 1712062902, 1712062902);
INSERT INTO `la_system_auth_menu` VALUES (778, 0, 'M', '溯源列表', 'el-icon-View', 0, '', 'resource', '', '', '', 1, 1, 0, 1712126109, 1712126109);
INSERT INTO `la_system_auth_menu` VALUES (779, 778, 'C', '溯源列表', 'el-icon-View', 0, '', 'resource/index', 'resource/index', '', '', 1, 1, 0, 1712126135, 1712126135);
...
CREATE TABLE `la_system_log_login`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统登录日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of la_system_log_login
-- ----------------------------
INSERT INTO `la_system_log_login` VALUES (1, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712058869);
INSERT INTO `la_system_log_login` VALUES (2, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712067953);
INSERT INTO `la_system_log_login` VALUES (3, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712068111);
INSERT INTO `la_system_log_login` VALUES (4, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712068151);
INSERT INTO `la_system_log_login` VALUES (5, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712068421);
INSERT INTO `la_system_log_login` VALUES (6, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712112175);
INSERT INTO `la_system_log_login` VALUES (7, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712112195);
INSERT INTO `la_system_log_login` VALUES (8, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712117364);
INSERT INTO `la_system_log_login` VALUES (9, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712126185);
INSERT INTO `la_system_log_login` VALUES (10, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1712131689);
...
-- ----------------------------
INSERT INTO `la_system_log_operate` VALUES (1, 1, 'GET', '角色列表', '127.0.0.1', '/api/system/role/list', 'likeadmin/admin/routers/system.roleHandler.list-fm', 'pageNo=1&pageSize=15', '', 1, 1712062301, 1712062301, 2, 1712062301);
INSERT INTO `la_system_log_operate` VALUES (2, 1, 'POST', '上传图片', '127.0.0.1', '/api/common/upload/image', 'DeviceResource/admin/routers/common.uploadHandler.uploadImage-fm', 'test.png', '', 1, 1712132667, 1712132667, 3, 1712132667);
