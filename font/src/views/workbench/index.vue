        ...
        <div class="md:flex">
            ...
            <el-card class="!border-none mb-4 flex-1" shadow="never">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-1/2 md:w-1/4">
                        <div class="leading-10">今日抓取数（件）</div>
                        <div class="text-6xl">{{ workbenchData.today.todayCapture }}</div>
                        <div class="text-tx-secondary text-xs">
                            总抓取数：{{ workbenchData.today.totalCapture }}
                        </div>
                    </div>
                    <div class="w-1/2 md:w-1/4">
                        <div class="leading-10">今日漏误数（件）</div>
                        <div class="text-6xl">{{ workbenchData.today.todayMiss }}</div>
                        <div class="text-tx-secondary text-xs">
                            总漏误数：{{ workbenchData.today.totalMiss }}
                        </div>
                    </div>
                    <div class="w-1/2 md:w-1/4">
                        <div class="leading-10">今日产出数（件）</div>
                        <div class="text-6xl">{{ workbenchData.today.todayOutput }}</div>
                        <div class="text-tx-secondary text-xs">
                            总产出数：{{ workbenchData.today.totalOutput }}
                        </div>
                    </div>
                </div>
            </el-card>
